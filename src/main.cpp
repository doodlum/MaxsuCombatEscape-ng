...
extern "C" DLLEXPORT bool SKSEAPI SKSEPlugin_Query(const SKSE::QueryInterface* a_skse, SKSE::PluginInfo* a_info)
{
	...
	*path /= "MaxsuCombatEscape.log"sv;
	...
	logger::info(FMT_STRING("MaxsuCombatEscape v{}"), MYFP_VERSION_VERSTRING);

	a_info->infoVersion = SKSE::PluginInfo::kVersion;
	a_info->name = "MaxsuCombatEscape";
...
{
	logger::info("MaxsuCombatEscape loaded");
